...
{
    /// <summary>
    /// The physical-interaction head representation - it is simplified into a sphere (head), a cylinders (neck) and a capsule (shoulders).
    /// </summary>
    class HeadNeckShoulders : RigidBody
    {
        // TODO: friction force on particles - Coulomb's model

        private const float interactionDistance = 0.3f;

        public HeadNeckShoulders( float mass ) : base( mass ) { }
