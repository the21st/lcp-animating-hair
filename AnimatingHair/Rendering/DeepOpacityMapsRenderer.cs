...
{
    /// <summary>
    /// Handles rendering of the Deep Opacity Map for hair.
    /// </summary>
    class DeepOpacityMapsRenderer
    {
        ...
        private int alphaThresholdLocDepth;
        ...
        private int alphaThresholdLocOpacity;
        ...
        public DeepOpacityMapsRenderer( Hair hair, Light light )
        {
            this.hair = hair;
            this.light = light;
        ...
        /// <summary>
        /// Renders the deep opacity map into a texture.
        /// </summary>
        ...
        private void renderDepthMap()
        {
            ...
            GL.Uniform1( alphaThresholdLocDepth, RenderingOptions.Instance.AlphaThreshold );
        ...
        private void renderOpacityMaps()
        {
            ...
            GL.Uniform1( alphaThresholdLocOpacity, RenderingOptions.Instance.AlphaThreshold );
        ...
        private void getShaderVariableLocations()
        {
            ...
            alphaThresholdLocDepth = GL.GetUniformLocation( depthShaderProgram, "alphaThreshold" );
            ...
            alphaThresholdLocOpacity = GL.GetUniformLocation( opacityShaderProgram, "alphaThreshold" );
